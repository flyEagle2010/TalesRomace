...
pomelo.request = function(route, msg, cb) {
    /*'connector.entryHandler.test', {uid:1,name:'test'}*/
    msg = msg || {};
...
var sendMessage = function(reqId, route, msg) {
    ...
    console.log("compressRoute:%d,%j",compressRoute,compressRoute);
...
pomelo.init({host: "127.0.0.1", port: 3010, log: true}, function() {
    ...
    pomelo.request('connector.entryHandler.test', {uid:1,name:'test'}, function(data) {
        console.log(data);
    });
});
